...
module.exports = {
    ...
    entry: {
        ...
        'mainApp': './src/mainApp/main.ts', // our main angular app
        'userInfo': './src/userInfo/main.ts' // userInfo app
    },
    output: {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            title: "userInfo",
            filename: 'web/userInfo/index.html',
            template: 'src/userInfo/index.html',
            chunks: ['polyfills', 'vendor', 'userInfo']
        }),
    ...
    devServer: {
        ...
        proxy: {
            '/web/userInfo/**': {
                target: 'http://localhost.example.com:8080/',
                pathRewrite: {
                    '/[0-9]+': ''
                }
            }
